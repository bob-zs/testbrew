...
export const PromptIcon = () => {
  return (
    <svg
      ...
      <path d='M5.99995 11.5H4.99995V12.5H5.99995V11.5Z' fill='#a3e635' />
      ...
      <path d='M5.99995 6.5H4.99995V7.5H5.99995V6.5Z' fill='#a3e635' />
      <path
